...
namespace Com.Infinario.Android.Infinariosdk {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.infinario.android.infinariosdk']/class[@name='ConnectivityReceiver']"
	[global::Android.Runtime.Register ("com/infinario/android/infinariosdk/ConnectivityReceiver", DoNotGenerateAcw=true)]
	public partial class ConnectivityReceiver : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/infinario/android/infinariosdk/ConnectivityReceiver", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.infinario.android.infinariosdk']/class[@name='ConnectivityReceiver']/constructor[@name='ConnectivityReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (ConnectivityReceiver)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Infinario.Android.Infinariosdk.ConnectivityReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Infinario.Android.Infinariosdk.ConnectivityReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.infinario.android.infinariosdk']/class[@name='ConnectivityReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
